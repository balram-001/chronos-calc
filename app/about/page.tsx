        ...
        <div className="max-w-[750px] mx-auto w-full">
          ...
          <div className={`border rounded-2xl p-6 sm:p-8 shadow-xl relative overflow-hidden ${darkMode ? "bg-slate-800 border-slate-700" : "bg-white border-gray-200"}`}>
            ...
            <div className="mt-4 flex flex-col gap-6">
              ...
              <div>
                <h3 className="text-xs font-black uppercase text-[#3b6e9c] mb-1.5 tracking-wider">3. Performance Optimization</h3>
                <p className="text-[11px] leading-relaxed text-gray-500 dark:text-gray-400">
                  Zero external structural dependency aur native client-side rendering engine ke karan, aapka data kisi server par store nahi hota. Har input calculations localized framework par instantaneous execute hoti hai jo is system ko fast aur secure banati hai.
                </p>
              </div>
            </div>
