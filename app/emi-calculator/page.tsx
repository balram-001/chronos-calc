          ...
          <div className={`border rounded-2xl p-5 sm:p-8 shadow-xl ${darkMode ? "bg-slate-800 border-slate-700" : "bg-white border-gray-200"}`}>
            ...
            <div className="grid grid-cols-3 gap-3 mt-8 pt-6 border-t border-gray-100 dark:border-slate-700 text-center">
              <div className={`p-3 rounded-xl border ${darkMode ? "bg-slate-900 border-slate-700 text-slate-200" : "bg-gray-100 border-gray-200 text-slate-800"}`}>
                <span className="text-[10px] uppercase font-black tracking-wider text-gray-400 block mb-1">Monthly EMI</span>
                <span className="text-xs sm:text-sm font-black text-amber-500">₹{Math.round(emi).toLocaleString("en-IN")}</span>
              </div>
              <div className={`p-3 rounded-xl border ${darkMode ? "bg-slate-900 border-slate-700 text-slate-200" : "bg-gray-100 border-gray-200 text-slate-800"}`}>
                <span className="text-[10px] uppercase font-black tracking-wider text-gray-400 block mb-1">Total Interest</span>
              ...
              <div className={`p-3 rounded-xl border ${darkMode ? "bg-slate-900 border-slate-700 text-slate-200" : "bg-gray-100 border-gray-200 text-slate-800"}`}>
                <span className="text-[10px] uppercase font-black tracking-wider text-gray-400 block mb-1">Total Payable</span>
