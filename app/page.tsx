      ...
      <header className={`w-full border-b py-3 px-4 flex justify-center sticky top-0 z-50 ${darkMode ? "bg-slate-800 border-slate-700 shadow-md" : "bg-white border-gray-200 shadow-sm"}`}>
        <div className="w-full max-w-[1050px] flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/about" className={`text-[10px] font-black uppercase tracking-wider ${darkMode ? "text-gray-400 hover:text-white" : "text-gray-500 hover:text-slate-800"}`}>About</Link>
            <button onClick={toggleDarkMode} className={`px-2.5 py-1 rounded-md border text-[9px] font-black uppercase tracking-wider ${darkMode ? "border-slate-700 text-yellow-400 bg-slate-800" : "border-gray-100 bg-gray-50 text-slate-600"}`}>
